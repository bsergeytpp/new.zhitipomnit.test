		<div class="comments-form-div">
			...
			?>
					<form onsubmit="return false;" method="POST" class="comments-form">
						...
						<p><span>Логин:</span> <input name="comments-login" readonly="readonly" required type="text" value="<? echo $userData['user_login']; ?>"></input></p>
						<p><span>Email:</span> <input name="comments-email" readonly="readonly" required type="text" value="<? echo $userData['user_email']; ?>"></input></p>
